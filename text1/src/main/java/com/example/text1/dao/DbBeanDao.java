...
public class DbBeanDao extends AbstractDao<DbBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Dase = new Property(2, String.class, "dase", false, "DASE");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, DbBean entity) {
        ...
        String dase = entity.getDase();
        if (dase != null) {
            stmt.bindString(3, dase);
        }
    }
    ...
    public DbBean readEntity(Cursor cursor, int offset) {
        DbBean entity = new DbBean( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // dase
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DbBean entity, int offset) {
        ...
        entity.setDase(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
